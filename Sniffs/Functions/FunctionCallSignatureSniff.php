 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Snap_Sniffs_Functions_FunctionCallSignatureSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function processMultiLineCall(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $openBracket, $tokens)
    {
        ...
        // Each line between the parenthesis should be indented 1 tab.
        $closeBracket = $tokens[$openBracket]['parenthesis_closer'];
        ...
        for ($i = ($openBracket + 1); $i < $closeBracket; $i++) {
            ...
            if ($tokens[$i]['line'] !== $lastLine) {
                ...
                if ($nextCode === $closeBracket) {
                    ...
                    $expectedIndent = ($functionIndent + 1); // 1 tab
                }
